...
if (isset($_POST['login'])) {
 ...
 // } else {
  ...
  $result = mysqli_query($connection,"select * from student where email='" . $_SESSION['usr_id'] . "'");
  ...
  <div class="info">
        ...
        <tr>
            ...
            <td class="auto-style4">
                <input id="Text1" type="text" value='<?php echo  $accountnumber; ?>'/></td><br>
        </tr>
        <tr>
            <td> <font color="#fffffff" size = "5">Roll:</font></td><br>
            <td class="auto-style4">
                <input id="Text2" type="text" value='<?php echo  $title; ?>'/></td><br>
        </tr>
        <tr>
             <td> <font color="#fffffff" size = "5">Educational Year:</font></td><br>
            <td class="auto-style4">
                <input id="Text3" type="text" value='<?php echo  $fname; ?>' /></td><br>
        </tr>
        <tr>
             <td> <font color="#fffffff" size = "5">Phone:</font></td><br>
            <td class="auto-style4">
                <input id="Text4" type="text" value='<?php echo  $lname; ?>' /></td><br>
        </tr>
        <tr>
           <td> <font color="#fffffff" size = "5">Current year:</font></td><br>
            <td class="auto-style4">
                <input id="Text6" type="text" value='<?php echo  $add2; ?>' ></td><br>
        </tr>
        <tr>
            <td> <font color="#fffffff" size = "5">Current Term:</font></td><br>
            <td class="auto-style4">
                <input id="Text5" type="text" value='<?php echo  $add1; ?>' /></td><br>
        </tr>
